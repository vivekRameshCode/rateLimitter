...
/**
 * This is the extension manager of the Ratelimiter extension.
 */
public class RatelimiterManager extends GeneratedRatelimiterManager
{
	...
	{
		return (RatelimiterManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RatelimiterConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RatelimiterManager() // NOPMD 
	{
		LOG.debug("constructor of RatelimiterManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of RatelimiterManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of RatelimiterManager called, current tenant: {}", getTenant().getTenantID());
	}
