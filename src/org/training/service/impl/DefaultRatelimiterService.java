...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultRatelimiterService.class);
	...
	{
		return DefaultRatelimiterService.class.getResourceAsStream("/ratelimiter/sap-hybris-platform.png");
	}
